...
<?php $__env->startSection('body'); ?>
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form class="validation-form" method="post" action="<?php echo e(URL::to('admin/product/insert-product')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                ...
                                <div class="card-body card-article">
                                    ...
                                    <div class="form-group title">
                                        ...
                                        <input type="text" class="form-control for-seo text-sm" name="name"
                                            id="" placeholder="Tên ..." value="<?php echo e($row_product['name']); ?>" required>
                                    </div>
                                    <div class="form-group title...">
                                        <label for="name...">Nội dung:</label>
                                        <textarea class="form-control for-seo text-sm " name="content" id="content" rows="5" placeholder="Nội dung ..."><?php echo e($row_product['content']); ?></textarea>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label class="d-block" for="code">Mã sản phẩm:</label>
                                            <input type="text" class="form-control text-sm" name="code" id="code"
                                                placeholder="Mã sản phẩm" value="<?php echo e($row_product['code']); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input type="text"
                                                    ...
                                                    id="price_regular" placeholder="Giá gốc" value="<?php echo e($row_product['price_regular']); ?>">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control format-price sale_price text-sm"
                                                    name="sale_price" id="sale_price" placeholder="Giá mới" value="<?php echo e($row_product['sale_price']); ?>">
                                                <div class="input-group-append">
                                                    <div class="input-group-text"><strong>VNĐ</strong></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control format-price sale_price text-sm"
                                                    name="discount" id="discount" placeholder="Giá mới" value="<?php echo e($row_product['discount']); ?>">
                                                <div class="input-group-append">
                                                    <div class="input-group-text"><strong>VNĐ</strong></div>
                                                </div>
                                            </div>
