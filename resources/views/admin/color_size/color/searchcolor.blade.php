        ...
        <div class="container-fluid">
            <div class="card-footer text-sm sticky-top">
                ...
                <div class="form-inline form-search d-inline-block align-middle ml-3">
                    <form action="{{URL::to('/searchcolor')}}"method="POST" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table card-table table-hover">
                        <thead>
                            ...
                            @foreach ($search_color as $k => $item)
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <input type="number"
                                                ...
                                                value="{{$item->id}}" data-id="" data-table="product"
                                                readonly>
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            <a class="text-dark text-break"
                                                href="{{ route('sua-doi-mau-sac-admin', ['id' => $item->id]) }}"
                                                title="{{ $item->name }}"><input type="color" class="" value="{{ $item->code }}" disabled style="width: 300px;border:0"></a>
                                        </td>
                                        ...
                                        <td class="align-middle text-center text-md text-nowrap">
                                            ...
                                            <a class="text-danger delete-item"
                                                data-href="{{ route('xl-xoa-bo-mau-sac-admin') . '?id=' . $item->id }}"
