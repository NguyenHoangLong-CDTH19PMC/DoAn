    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card-footer text-sm sticky-top">
                <a class="btn btn-sm bg-gradient-primary text-white" href="{{ route('them-moi-loai-bai-viet-admin') }}"
                ...
                <div class="form-inline form-search d-inline-block align-middle ml-3">
                    <form action="{{URL::to('/searchsize')}}" method="POST" enctype="multipart/form-data">
                        @csrf
            ...
            <div class="card card-primary card-outline text-sm mb-0">
                <div class="card-header">
                    <h3 class="card-title"><b>Danh sách loại bài viết</b></h3>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <input type="number"
                                                ...
                                                value="{{ $serial++ }}" data-id="" data-table="newtype"
                                                readonly>
                                        </td>

                                        <td class="align-middle">
                                                <a href="{{ route('sua-doi-kich-thuoc-admin', ['id' => $item->id]) }}"
                                                    title="{{ $item->name }}">
                                                    <img class="rounded img-preview"
                                                        src="{{ asset('upload/new/' . $item->photo) }}"
                                        ...
                                        <td class="align-middle">
                                            <a class="text-dark text-break"
                                                href="{{ route('sua-doi-loai-bai-viet-admin', ['id' => $item->id]) }}"
                                        ...
                                        <td class="align-middle text-center text-md text-nowrap">
                                            ...
                                            <a class="text-danger delete-item"
                                                data-href="{{ route('xl-xoa-bo-loai-bai-viet-admin') . '?id=' . $item->id }}"
