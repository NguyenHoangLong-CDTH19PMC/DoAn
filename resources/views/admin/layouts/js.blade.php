...
<!-- Sparkline -->
<script src="{{asset('assets/admin/js/sparklines/sparkline.js')}}"></script>
<!-- JQVMap -->
<script src="{{asset('assets/admin/js/jqvmap/jquery.vmap.min.js')}}"></script>
<script src="{{asset('assets/admin/js/jqvmap/maps/jquery.vmap.usa.js')}}"></script>
<!-- jQuery Knob Chart -->
<script src="{{asset('assets/admin/js/jquery-knob/jquery.knob.min.js')}}"></script>
<!-- daterangepicker -->
...
<script src="{{asset('assets/admin/js/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js')}}"></script>
<!-- Summernote -->
