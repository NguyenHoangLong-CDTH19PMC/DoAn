                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <th class="align-middle" width="5%">
                                    ...
                                    <img src="/img/{{$product->image}}" alt="IMG-PRODUCT" style="width:100px"/>   
                                    </th>

                                    <th class="align-middle">{{$product->id_product_type}}</th>

                                    <th class="align-middle" style="width:30%">{{$product->name}}</th>

                                    <th class="align-middle">{{number_format($product->price_regular)}}</th>
