                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <input type="number" class="form-control form-control-mini m-auto update-numb"
                                                min="0" value="{{$item->serial}}" data-id="" data-table="product"
                                                >
                                        </td>
                                        <td class="align-middle">
                                        ...
                                        {{-- <td class="align-middle">
                                        <a href="" title="">
                                            <img class="rounded img-preview" src="{{ asset('upload/photo/$item->name') }}" onerror="src='{{ asset('assets/admin/images/noimage.png') }}'" alt="Alt Photo" style=""/>
                                        </a>
                                    </td> --}}
                                        ...
                                        {{-- <td class="align-middle text-center">
                                            <div class="custom-control custom-checkbox my-checkbox">
                                                <input type="checkbox" class="custom-control-input show-checkbox"
                                                    id="show-checkbox" data-table="product" data-id=""
                                                    data-attr="">
