                ...
                <div class="row">
                    <ol class="breadcrumb float-sm-left pl-3">
                        <li class="breadcrumb-item"><a href="{{ route('trang-chu-admin') }}" title="Bảng điều khiển">Bảng điều
                                khiển</a></li>
                        <li class="breadcrumb-item active">Chỉnh sửa danh mục cấp 2</li>
                    </ol>
                </div>
            </div>
        </section>
                                ...
                                <div class="form-group col-xl-6 col-sm-4">
                                    <select id="select-category1" name="categorylv1" class="form-control select2">
                                        ...
                                        @foreach ($dslevel1 as $k => $value)
                                            <option value="{{ $value->id }}" {{ ($value->id == $detailLV2->id_level1) ? "selected" : "" }}>{{ $value->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="card card-default color-palette-box card-primary card-outline text-sm">
                                ...
                                <div class="card-body card-article">
                                    <div class="form-group title">
                                        ...
                                        <input type="text" class="form-control for-seo text-sm" name="tendm" value="{{$detailLV2->name}}"
                                    ...
                                    {{-- <div class="form-group titleProduct">
                                        ...
                                        <textarea class="form-control for-seo text-sm " name="noidung" id="" rows="5" placeholder="Nội dung ">{!!html_entity_decode($detailLV2->content)!!}</textarea>
                                    </div> --}}
                                </div>
                            </div>
                        </div>
