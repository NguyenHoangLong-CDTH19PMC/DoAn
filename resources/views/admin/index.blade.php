...
<html lang="en">
   <head>
      ...
      <!-- site icon -->
      <link rel="icon" href="{{asset('assets/admin/images/logo/logo-2.ico')}}" type="image/x-icon" />
      <!-- bootstrap css -->
            ...
            <nav id="sidebar">
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="logo_section">
                        <a href=""><img class="logo_icon img-responsive" src="{{asset('assets/admin/images/logo/logo_icon.png')}}" alt="#" /></a>
                     </div>
                  </div>
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href=""><i class="fas fa-clock orange_color"></i> <span>Widgets</span></a></li>
                     <li>
                        <a href="#element" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fas fa-diamond purple_color"></i> <span>Elements</span></a>
                     ...
                     <li><a href="tables.html"><i class="fas fa-table purple_color2"></i> <span>Tables</span></a></li>
                     <li>
                     ...
                     <li><a href=""><i class="fas fa-briefcase blue1_color"></i> <span>Pricing Tables</span></a></li>
                     <li>
                        <a href="">
                        <i class="fas fa-paper-plane red_color"></i> <span>Contact</span></a>
                     </li>
                     <li class="active">
                        <a href="#additional_page" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fas fa-clone yellow_color"></i> <span>Additional Pages</span></a>
                     ...
                     <li><a href=""><i class="fas fa-map purple_color2"></i><span>Map</span></a></li>
                     <li><a href=""><i class="fas fa-bar-chart green_color"></i><span>Charts</span></a></li>
                     <li><a href=""><i class="fas fa-cog yellow_color"></i><span>Settings</span></a></li>
                  </ul>
               </div>
            </nav>
            <!-- end sidebar -->
               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href=""><img class="img-responsive" src="{{asset('assets/admin/images/logo/logo.png')}}" alt="#" /></a>
                        </div>
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="{{asset('assets/admin/images/layout_img/user_img.jpg')}}" alt="#" /><span class="name_user">John David</span></a>
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="">My Profile</a>
                                       <a class="dropdown-item" href="">Settings</a>
                                       <a class="dropdown-item" href="">Help</a>
                                       <a class="dropdown-item" href=""><span>Log Out</span> <i class="fas fa-sign-out"></i></a>
                                    </div>
                                 </li>
                              </ul>
                           </div>
                     ...
                     <div class="row column1">
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fas fa-user yellow_color"></i>
                                 </div>
                              </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fas fa-clock blue1_color"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                 <div>
                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fas fa-cloud-download green_color"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                 <div>
                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fas fa-comments red_color"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                 <div>
                     ...
                     <div class="row column4 graph">
                        <div class="col-md-6 margin_bottom_30">
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 <div class="dash_head">
                                    <h3><span><i class="fas fa-calendar"></i> 6 July 2018</span><span class="plus_green_bt"><a href="#">+</a></span></h3>
                                 </div>
                                 <div class="list_cont">
                        ...
                        <div class="col-md-6">
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 <div class="dash_head">
                                    <h3><span><i class="fas fa-comments-o"></i> Updates</span><span class="plus_green_bt"><a href="#">+</a></span></h3>
                                 </div>
                                 <div class="list_cont">
